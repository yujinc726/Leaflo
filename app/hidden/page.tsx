...
// Fun background with Park Yeon-jin's image
function YeonJinBackground() {
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none opacity-20 blur-sm">
      <motion.div
        className="absolute"
        style={{ top: '5%', left: '10%', width: 250, height: 350 }}
        initial={{ opacity: 0, scale: 0.8, rotate: -15 }}
        animate={{ opacity: [0, 1, 0], scale: [0.8, 1, 0.8] }}
        transition={{ duration: 20, repeat: Infinity, delay: 0, ease: "easeInOut" }}
      >
        <Image src="/park-yeon-jin.jpg" alt="박연진" layout="fill" className="object-cover" />
      </motion.div>
      <motion.div
      ...
      >
        <Image src="/park-yeon-jin.jpg" alt="박연진" layout="fill" className="object-cover rounded-full" />
      </motion.div>
      <motion.div
        className="absolute rounded-full"
        style={{ bottom: '10%', left: '30%', width: 200, height: 200 }}
      ...
      >
       ...
       <motion.div
        className="absolute"
        style={{ top: '50%', left: '40%', width: 180, height: 240 }}
        initial={{ opacity: 0, scale: 0.8, rotate: 5 }}
        animate={{ opacity: [0, 0.8, 0], scale: [0.8, 1, 0.8] }}
        transition={{ duration: 22, repeat: Infinity, delay: 7, ease: "easeInOut" }}
      >
        <Image src="/park-yeon-jin.jpg" alt="박연진" layout="fill" className="object-cover" />
      </motion.div>
    </div>
...
export default function HiddenAboutPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-emerald-50 relative">
      <YeonJinBackground />
      <div className="relative z-10">
